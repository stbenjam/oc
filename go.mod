...
require (
	...
	sigs.k8s.io/yaml v0.0.0-20190704183835-4cd0c284b15f
	vbom.ml/util v0.0.0-20160121211510-db5cfe13f5cc // indirect
)

replace github.com/golang/glog => github.com/openshift/glog v0.0.0-20190322123450-3c92600d7533

replace github.com/onsi/ginkgo => github.com/openshift/ginkgo v1.2.1-0.20190125161613-53ca7dc85f60

replace k8s.io/apimachinery => github.com/openshift/kubernetes-apimachinery v0.0.0-20190723174002-b11b32a81c68

replace github.com/containers/image => github.com/openshift/containers-image v0.0.0-20190130162827-4bc6d24282b1

replace k8s.io/cli-runtime => github.com/openshift/kubernetes-cli-runtime v0.0.0-20190723170929-2fdfcf685c9c

replace github.com/docker/distribution => github.com/openshift/docker-distribution v0.0.0-20180925154709-d4c35485a70d

replace k8s.io/kubernetes => github.com/openshift/kubernetes v1.14.1-0.20190723172226-473b2830919b

replace k8s.io/client-go => github.com/openshift/kubernetes-client-go v11.0.1-0.20190723174301-07e29e5eae48+incompatible
